...
const DailyMeet: React.FC<DailyMeetProps> = ({ roomName, displayName, onClose, visible }) => {
  ...
  useEffect(() => {
    if (visible && roomName) {
      ...
      window.open(`/videochamada/${roomName}`, '_blank', 'width=1400,height=900');
      onClose();
    }
